...
''' % (basename(__file__), self.trans_port, self.virtual_net,
  ...
  def get_ip(self):
    ...
    f.close()
    new_mac=random_mac()
    print("MAC Randomized to " + new_mac)    
    # str(input("Enter a new MAC in xx:xx:xx:xx:xx:xx format "))
...
if __name__ == '__main__':
  ...
  try:
    ...
    if args.load:
      ...
      subprocess.call(["sudo","ifconfig","wlan0","down"])
      #print("2")
      subprocess.call(["sudo","ifconfig","wlan0","hw","ether",contents])
      #print("3")
      subprocess.call(["sudo","ifconfig","wlan0","up"])
      #print("4")
      print("MAC changed back to "+contents)
#     print("5")
      print(" {0}".format(
